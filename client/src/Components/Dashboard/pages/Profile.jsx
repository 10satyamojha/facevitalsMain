  ...
  useEffect(() => {
    async function fetchProfile() {
      try {
        ...
        const response = await axios.get('https://facevital-backend-3.onrender.com/api/profile/getProfile', {
          headers: {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://facevital-backend-3.onrender.com/api/profile/createOrUpdateProfile',
        updateData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
