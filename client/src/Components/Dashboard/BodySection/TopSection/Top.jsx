...
const HealthVitalsDashboard = () => {
  ...
  const fetchProfileData = async () => {
    try {
      ...
      const response = await fetch('https://facevital-backend-3.onrender.com/api/profile/getProfile', {
        headers: {
  ...
  const fetchVitalsData = async () => {
    try {
      const token = localStorage.getItem('authToken');
      const response = await fetch('https://facevital-backend-3.onrender.com/api/vitals/latest', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchActivityData = async () => {
    try {
      const token = localStorage.getItem('authToken');
      const response = await fetch('https://facevital-backend-3.onrender.com/api/activity/recent', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchNotifications = async () => {
    try {
      const token = localStorage.getItem('authToken');
      const response = await fetch('https://facevital-backend-3.onrender.com/api/notifications', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchApiUsage = async () => {
    try {
      const token = localStorage.getItem('authToken');
      const response = await fetch('https://facevital-backend-3.onrender.com/api/usage-stats', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
