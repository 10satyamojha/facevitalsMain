...
import { MdHealthAndSafety, MdOutlineApi, MdOutlinePersonPin } from 'react-icons/md'
...
import { BiTrendingUp, BiLogOutCircle, BiKey, BiUser } from 'react-icons/bi'
...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    else if (path.includes('vitals')) setActiveItem('vitals')
    else if (path.includes('analytics')) setActiveItem('analytics')
    else if (path.includes('api-keys')) setActiveItem('api-keys')
    else if (path.includes('profile')) setActiveItem('profile')
    else if (path.includes('results')) setActiveItem('results')
