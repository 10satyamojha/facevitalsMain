...
import { Key, Copy, Eye, EyeOff, Trash2, Plus, Shield, RefreshCw } from 'lucide-react'
...
const APIKeys = () => {
  ...
  useEffect(() => {
    // Load API keys from memory (not localStorage as per restrictions)
    const sampleKeys = [
      {
        id: 1,
        name: 'Main Dashboard Key',
        key: 'hv_live_sk_1234567890abcdef1234567890abcdef',
        created: '2024-03-01',
        lastUsed: '2024-03-15',
      ...
      },
      {
        id: 2,
        name: 'Mobile App Key',
        key: 'hv_live_sk_abcdef1234567890abcdef1234567890',
        created: '2024-02-15',
        lastUsed: '2024-03-10',
        permissions: ['read'],
        status: 'active',
